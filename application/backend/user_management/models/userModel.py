...
class Organization(models.Model):
    ...
    organization_id = models.IntegerField(primary_key = True, max_length=5)
...
class Role(models.Model):
    ...
    role_id = models.IntegerField(primary_key = True, max_length=3)
    #name of the role
...
class UserOrganization(models.Model):
    ...
    user_id = models.ForeignKey(User, max_length=50, on_delete=models.CASCADE)
    #refrence organization_id to Organization model organization_id as ForeignKey
    organization_id = models.ForeignKey(Organization, max_length=10, on_delete=models.CASCADE)
...
class UserRole(models.Model):
    ...
    role_id = models.ForeignKey(Role, max_length=3, on_delete = models.CASCADE)
